        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 mb-8">
          ...
          <div className="flex items-center border rounded-md overflow-hidden text-sm">
            <button
              ...
              disabled={cantidad <= 1}
              className="text-gray-600 px-2 py-1 disabled:opacity-50 hover:text-black transition-colors"
            >
              <Minus size={14} />
            </button>
            <input
              ...
              className="w-12 text-center border-x py-1 focus:outline-none focus:ring-1 focus:ring-blue-500 text-sm"
            />
            <button
              onClick={() =>
