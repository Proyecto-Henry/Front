...
const ChangePlan = () => {
  ...
  <option value="PREMIUM">PREMIUM (4 stores)</option>
          ...
          <button
            ...
            disabled={loading}
            className="w-full px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors disabled:bg-blue-300 disabled:cursor-not-allowed flex items-center justify-center"
          >
          ...
          <button
            ...
            className="mt-4 text-blue-600 hover:text-blue-800 transition-colors underline"
          >
