...
interface IAdmin { name: string; email: string; cantsucursales: number }
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 bg-gradient-to-b from-[#f9f9fd] to-[#4470af] p-6">
        <div className="max-w-6xl mx-auto flex flex-col items-center">
          <h1 className="text-3xl font-bold text-center mb-8 text-gray-800">HOLA {/* {userData.name} */}	</h1>
          ...
          <div className="flex flex-col items-center justify-center bg-white/90 rounded-xl shadow-lg p-8 mb-12 w-full max-w-md">
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="text-center">
                <p className="text-lg font-medium text-gray-800 mb-2">{userData?.user.email}</p>
                <div className="bg-blue-100 px-4 py-2 rounded-full">
                  <p className="text-blue-800 font-medium">Tienes {userData?.cantsucursales} sucursales</p>
                </div>
              </div>
            </div>
          </div>
            ...
            {sucursales.map((card, index) => (
              <div key={index} className="flex justify-center">
                <div className="bg-gray-200 bg-opacity-80 rounded-xl p-6 w-64">
                  <h3 className="text-lg font-medium text-center mb-8">{card.nombre}</h3>
