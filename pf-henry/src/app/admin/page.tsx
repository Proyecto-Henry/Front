  ...
  useEffect(() => {
    ...
    return (
        ...
        <div className="w-full max-w-6xl mx-auto rounded-2xl m-4 overflow-hidden bg-gradient-to-b from-[#f9f9fd] to-[#4470af] p-8 min-h-[500px] shadow-[5px_20px_50px_#00000066]">
          <h1 className="text-3xl font-bold text-center mb-8 text-gray-800">{user ? `HOLA ${user.name}` : 'Hola, [Admin]'}</h1>

          <div className="bg-gray-200 bg-opacity-80 rounded-xl p-6 mb-8 relative max-w-2xl mx-auto min-h-[100px]">
            <h2 className="text-xl font-semibold text-center text-gray-800">user.email</h2>
            <h2 className="text-xl font-semibold text-center text-gray-800">user.phone</h2>
            <h2 className="text-xl font-semibold text-center text-gray-800">user.country</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            <div className="bg-gray-200 bg-opacity-80 rounded-xl p-6 flex flex-col items-center justify-between min-h-[200px]">
              <h3 className="text-lg font-semibold mb-4 text-gray-800">Sucursal</h3>
            ...
            <div className="bg-gray-200 bg-opacity-80 rounded-xl p-6 flex flex-col items-center justify-between min-h-[200px]">
              <h3 className="text-lg font-semibold mb-4 text-gray-800">Agregar Sucursal</h3>
